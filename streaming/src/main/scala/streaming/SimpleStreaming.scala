...
object SimpleStreaming extends ExtraStreamOps {
  ...
  def sumUntilBackpressureGoesAway: Flow[Int, Int, _] =
    Flow[Int].conflate(_ + _).logAllEvents("sumUntilBackpressureGoesAway")
  ...
  def keepRepeatingLastObservedValue: Flow[Int, Int, _] =
    Flow[Int].extrapolate(e ⇒ Iterator.continually(e)).logAllEvents("sumUntilBackpressureGoesAway")
